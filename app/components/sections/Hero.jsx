  ...
  return (
    <motion.div style={{ opacity: textOpacity }} className="w-full flex justify-center bg-primary pt-8 pb-4 overflow-hidden pointer-events-none select-none">
      <motion.h1 
        ...
        className="text-[10vw] md:text-[9vw] lg:text-[8.5vw] font-black tracking-tighter text-[#1a1a1a] leading-[0.7] whitespace-nowrap flex overflow-hidden"
  ...
  return (
    <section className="relative w-full h-[120vh] bg-primary overflow-hidden" data-component="reel">
      ...
      <motion.div 
        ...
        className="absolute top-[72vh] md:top-14 left-0 w-full flex flex-col items-center z-20 pointer-events-none"
      >
