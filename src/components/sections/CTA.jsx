  ...
  return (
    <section className="w-full px-6 mb-20 bg-transparent">
      ...
      <div className="max-w-[1400px] mx-auto grid md:grid-cols-2 gap-4">
        {/* Left Card */}
        <div className="bg-[#1a1a1a] text-[#f9c4d2] p-8 md:p-10 h-[300px] md:h-[350px] flex flex-col justify-between cursor-pointer group hover:opacity-95 transition-opacity border border-white/10 rounded-xl">
        ...
        {/* Right Card */}
        <div className="bg-[#cba6f7] text-black p-8 md:p-10 h-[300px] md:h-[350px] flex flex-col justify-between cursor-pointer group hover:opacity-95 transition-opacity rounded-xl">
