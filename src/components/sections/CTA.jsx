    ...
    <section className="w-full px-6 mb-20 bg-transparent">
      ...
      <div className="max-w-[1400px] mx-auto grid md:grid-cols-2 gap-4">
        ...
        <div className="bg-[#E8E6DF] text-[#0b1121] p-8 md:p-10 h-[300px] md:h-[350px] flex flex-col justify-between cursor-pointer group hover:opacity-95 transition-opacity border border-white/10 rounded-xl">
          <p className="italic text-lg md:text-xl leading-tight" style={{ fontFamily: "'Nib Pro', serif" }}>
        ...
        <div className="bg-[#2B59C3] text-white p-8 md:p-10 h-[300px] md:h-[350px] flex flex-col justify-between cursor-pointer group hover:opacity-95 transition-opacity rounded-xl">
          <p className="italic text-base md:text-lg leading-snug max-w-sm" style={{ fontFamily: "'Nib Pro', serif" }}>
